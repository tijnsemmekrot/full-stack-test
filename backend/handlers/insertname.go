...
func InsertFirstName(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		http.Error(w, "Only POST allowed", http.StatusMethodNotAllowed)
		return
	}

	var req models.FirstNameRequest
	...
	log.Printf("Inserting name: %q into MongoDB", req.Name)
	...
	response := models.Response{
		Message: req.Name + " added to MongoDB!",
		ID:      idStr,
	}
